                ...
                <div className="row align-items-center">
                    ...
                    <div className="col-lg-5">
                        ...
                        <div className="agk-button float-lg-end mb-60 text-lg-end text-center pf_fadeup">
                            <Link to="/blog" className="theme-btn style-one">
                    ...
                    <div className="col-xl-6">
                        ...
                        <div className="agenko-blog-item style-two mb-40 pf_fadeup">
                            ...
                            <div className="post-content">
                                ...
                                <h4 className="title"><Link to="/blog/blog-details">MKT Gency for your online 
                    ...
                    <div className="col-xl-6">
                        ...
                        <div className="agenko-blog-item style-two mb-40 pf_fadeup">
                            ...
                            <div className="post-content">
                                ...
                                <h4 className="title"><Link to="/blog/blog-details">Meeting Collaboration for
