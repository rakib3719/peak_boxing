                                    ...
                                    <div className="agenko-blog-item style-three mb-40 pf_fadeup">
                                        ...
                                        <div className="post-content-wrap">
                                            <div className="post-content">
                                                ...
                                                <h4 className="title"><Link to="/blog/blog-details">Creative Javanese a Lead Designer & Mobile 
                                                    UI/UX Core Checklist</Link></h4>
                                            </div>
                                            <div className="post-button">
                                                <Link to="/blog/blog-details" className="icon-btn style-one"><i className="bi bi-arrow-right"></i></Link>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div className="agenko-blog-item style-three mb-40 pf_fadeup">
                                        ...
                                        <div className="post-content-wrap">
                                            <div className="post-content">
                                                ...
                                                <h4 className="title"><Link to="/blog/blog-details">Defensive Guide to Make a Daily More Creative 
