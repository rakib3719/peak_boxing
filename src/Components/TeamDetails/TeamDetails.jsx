                            ...
                            <div className="col-lg-5">
                                <div className="agenko-image-box mb-50 pf_fadeup">
                                    <div className="agenko-image">
                                        <img src="/assets/images/pages/team/team-single1.jpg" alt="Team" />
                                    </div>
                                </div>
                            </div>
